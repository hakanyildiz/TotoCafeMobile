package com.sohos.totocafemobile.restful;/* JSON API for totoCafe Android Appliation */
...
public class RestAPI {
    private final String urlString = "http://totowebservices.azurewebsites.net/totoHandler.ashx";
    ...
    public JSONObject getCategoriesOfCompany(double CompanyID) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "getCategoriesOfCompany");
    ...
    public JSONObject getProductViaCategory(double CategoryID) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "getProductViaCategory");
        p.put("CategoryID",mapObject(CategoryID));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
